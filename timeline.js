Meteor.MyTimelineModule = (function () {
	var oPublic = {};
 ...
 * "oPublic.links"
 */
if (typeof oPublic.links === 'undefined') {
	oPublic.links = {};
    // important: do not use var, as "var oPublic.links = {};" will overwrite 
    //            the existing oPublic.links variable value with undefined in IE8, IE7.  
}


/**
 * Ensure the variable oPublic.google exists
 */
if (typeof oPublic.google === 'undefined') {
	oPublic.google = undefined;
    // important: do not use var, as "var oPublic.google = undefined;" will overwrite 
    //            the existing oPublic.google variable value with undefined in IE8, IE7.
}
...
/**
 * @constructor oPublic.links.Timeline
 ...
 */
oPublic.links.Timeline = function(container) {
    if (!container) {
    ...
    this.clusterGenerator = new oPublic.links.Timeline.ClusterGenerator(this);
    ...
    this.step = new oPublic.links.Timeline.StepDate();

    // add standard item types
    this.itemTypes = {
        box:   oPublic.links.Timeline.ItemBox,
        range: oPublic.links.Timeline.ItemRange,
        dot:   oPublic.links.Timeline.ItemDot
    };
 ...
 *
 * @param {oPublic.google.visualization.DataTable}      data
 *                                 The data containing the events for the timeline.
 *                                 Object DataTable is defined in
 *                                 oPublic.google.visualization.DataTable
 * @param {Object} options         A name/value map containing settings for the
 *                                 timeline. Optional.
 */
oPublic.links.Timeline.prototype.draw = function(data, options) {
    this.setOptions(options);
    
    if (this.options.selectable) {
        oPublic.links.Timeline.addClassName(this.dom.frame, "timeline-selectable");
    }
 ...
 *                                 timeline. Optional.
 */
oPublic.links.Timeline.prototype.setOptions = function(options) {
    if (options) {
        ...
        if (typeof oPublic.links.locales !== 'undefined' && this.options.locale !== 'en') {
            var localeOpts = oPublic.links.locales[this.options.locale];
            if(localeOpts) {
 ...
 * @param {oPublic.links.Timeline.Item} typeFactory Constructor of items
 */
oPublic.links.Timeline.prototype.addItemType = function (typeName, typeFactory) {
 ...
 *         type: undefined
 *     }
 * @param {oPublic.google.visualization.DataTable} dataTable
 * @type {Object} map
 */
oPublic.links.Timeline.mapColumnIds = function (dataTable) {
    var cols = {},
 ...
 * @param {oPublic.google.visualization.DataTable | Array} data
 */
oPublic.links.Timeline.prototype.setData = function(data) {
    ...
    if (oPublic.google && oPublic.google.visualization &&
        data instanceof oPublic.google.visualization.DataTable) {
        // map the datatable columns
        var cols = oPublic.links.Timeline.mapColumnIds(data);
    ...
    else if (oPublic.links.Timeline.isArray(data)) {
        // read JSON array
 ...
 * @return {oPublic.google.visualization.DataTable | Array} data
 */
oPublic.links.Timeline.prototype.getData = function  () {
    return this.data;
};
 ...
 *                          {String} group
 */
oPublic.links.Timeline.prototype.updateData = function  (index, values) {
    var data = this.data,
        prop;

    if (oPublic.google && oPublic.google.visualization &&
        data instanceof oPublic.google.visualization.DataTable) {
        // update the original oPublic.google DataTable
 ...
 */
oPublic.links.Timeline.prototype.getItemIndex = function(element) {
    var e = element,
        dom = this.dom,
 ...
 *                         or "30%")
 */
oPublic.links.Timeline.prototype.setSize = function(width, height) {
    if (width) {
 ...
 *                           directly redrawn
 */
oPublic.links.Timeline.prototype.setVisibleChartRange = function(start, end, redraw) {
    var range = {};
    if (!start || !end) {
 ...
 */
oPublic.links.Timeline.prototype.setVisibleChartRangeAuto = function() {
 ...
 * of the timeline
 */
oPublic.links.Timeline.prototype.setVisibleChartRangeNow = function() {
    var now = new Date();
 ...
 */
oPublic.links.Timeline.prototype.getVisibleChartRange = function() {
    return {
 ...
 *                           will be undefined
 */
oPublic.links.Timeline.prototype.getDataRange = function (withMargin) {
    var items = this.items,
 ...
 *                                                        as default value
 */
oPublic.links.Timeline.prototype.render = function(options) {
 ...
 *                                 a reflow is needed.
 */
oPublic.links.Timeline.prototype.repaint = function() {
 ...
 *                              have been resized.
 */
oPublic.links.Timeline.prototype.reflowFrame = function() {
    var dom = this.dom,
 ...
 *                                 a reflow is needed.
 */
oPublic.links.Timeline.prototype.repaintFrame = function() {
    ...
    if (!dom.content) {
        ...
        if (!params.onMouseDown) {
            ...
            oPublic.links.Timeline.addEventListener(dom.content, "mousedown", params.onMouseDown);
        }
        if (!params.onTouchStart) {
            params.onTouchStart = function (event) {me.onTouchStart(event);};
            oPublic.links.Timeline.addEventListener(dom.content, "touchstart", params.onTouchStart);
        }
        if (!params.onMouseWheel) {
            params.onMouseWheel = function (event) {me.onMouseWheel(event);};
            oPublic.links.Timeline.addEventListener(dom.content, "mousewheel", params.onMouseWheel);
        }
        if (!params.onDblClick) {
            params.onDblClick = function (event) {me.onDblClick(event);};
            oPublic.links.Timeline.addEventListener(dom.content, "dblclick", params.onDblClick);
        }
 ...
 */
oPublic.links.Timeline.prototype.reflowAxis = function() {
    var resized = false,
        dom = this.dom,
        options = this.options,
        size = this.size,
 ...
 */
oPublic.links.Timeline.prototype.repaintAxis = function() {
    var needsReflow = false,
        dom = this.dom,
        options = this.options,
        size = this.size,
 ...
 *                                 a reflow is needed.
 */
oPublic.links.Timeline.prototype.repaintAxisCharacters = function () {
 ...
 */
oPublic.links.Timeline.prototype.repaintAxisStartOverwriting = function () {
 ...
 */
oPublic.links.Timeline.prototype.repaintAxisEndOverwriting = function () {
    var dom = this.dom,
 ...
 */
oPublic.links.Timeline.prototype.repaintAxisHorizontal = function() {
 ...
 * @param {String} text
 */
oPublic.links.Timeline.prototype.repaintAxisMinorText = function (x, text) {
    var size = this.size,
        dom = this.dom,
 ...
 * @param {Number} x
 */
oPublic.links.Timeline.prototype.repaintAxisMinorLine = function (x) {
 ...
 * @param {String} text
 */
oPublic.links.Timeline.prototype.repaintAxisMajorText = function (x, text) {
    var size = this.size,
        props = size.axis.properties,
        frame = this.dom.axis.frame,
 ...
 * @param {Number} x
 */
oPublic.links.Timeline.prototype.repaintAxisMajorLine = function (x) {
    var size = this.size,
        props = size.axis.properties,
        axis = this.size.axis,
        frame = this.dom.axis.frame,
 ...
 */
oPublic.links.Timeline.prototype.reflowItems = function() {
    var resized = false,
        i,
        iMax,
        group,
 ...
 *                              changed
 */
oPublic.links.Timeline.prototype.recalcItems = function () {
    var resized = false,
        i,
        iMax,
        item,
 ...
 */
oPublic.links.Timeline.prototype.clearItems = function() {
 ...
 *                                 a reflow is needed.
 */
oPublic.links.Timeline.prototype.repaintItems = function() {
    ...
    if (newImageUrls.length) {
        ...
        oPublic.links.imageloader.loadAll(newImageUrls, callback, sendCallbackWhenAlreadyLoaded);
    }
 ...
 *                              have been resized.
 */
oPublic.links.Timeline.prototype.reflowGroups = function() {
    var resized = false,
        options = this.options,
        size = this.size,
        dom = this.dom;
 ...
 */
oPublic.links.Timeline.prototype.repaintGroups = function() {
    var dom = this.dom,
        timeline = this,
        options = this.options,
        size = this.size,
    ...
    oPublic.links.Timeline.addClassName(frame, options.groupsOnRight ? 'timeline-groups-axis-onright' : 'timeline-groups-axis-onleft');
    ...
    if (dom.groups.frame && groups.length) {
        var imageUrls = [];
        oPublic.links.imageloader.filterImageUrls(dom.groups.frame, imageUrls);
        if (imageUrls.length) {
            // retrieve all image sources from the items, and set a callback once
            // all images are retrieved
            var callback = function () {
            ...
            var sendCallbackWhenAlreadyLoaded = false;
            oPublic.links.imageloader.loadAll(imageUrls, callback, sendCallbackWhenAlreadyLoaded);
        }
    }
};
 ...
 */
oPublic.links.Timeline.prototype.repaintCurrentTime = function() {
 ...
 */
oPublic.links.Timeline.prototype.repaintCustomTime = function() {
    var options = this.options,
        dom = this.dom,
        size = this.size;
 ...
 */
oPublic.links.Timeline.prototype.repaintDeleteButton = function () {
    var timeline = this,
        dom = this.dom,
        frame = dom.items.frame;
 ...
 */
oPublic.links.Timeline.prototype.repaintDragAreas = function () {
    var timeline = this,
        options = this.options,
        dom = this.dom,
    ...
    var index = this.selection ? this.selection.index : -1,
        item = this.selection ? this.items[index] : undefined;
    if (item && item.rendered && this.isEditable(item) &&
        (item instanceof oPublic.links.Timeline.ItemRange)) {
 ...
 */
oPublic.links.Timeline.prototype.repaintNavigation = function () {
    var timeline = this,
        options = this.options,
        dom = this.dom,
        frame = dom.frame,
    ...
    if (!navBar) {
        ...
        if (showButtonNew) {
            ...
            var onAdd = function(event) {
                oPublic.links.Timeline.preventDefault(event);
                oPublic.links.Timeline.stopPropagation(event);
            ...
            oPublic.links.Timeline.addEventListener(navBar.addButton, "mousedown", onAdd);
            navBar.appendChild(navBar.addButton);
        }

	    if (showButtonNew && showNavigation) {
            // create a separator line
            oPublic.links.Timeline.addClassName(navBar.addButton, 'timeline-navigation-new-line');
        }
        ...
        if (showNavigation) {
            if (options.zoomable) {
                ...
                oPublic.links.Timeline.addEventListener(navBar.zoomInButton, "mousedown", onZoomIn);
                ...
                oPublic.links.Timeline.addEventListener(navBar.zoomOutButton, "mousedown", onZoomOut);
            ...
            if (options.moveable) {
                ...
                oPublic.links.Timeline.addEventListener(navBar.moveLeftButton, "mousedown", onMoveLeft);
                ...
                oPublic.links.Timeline.addEventListener(navBar.moveRightButton, "mousedown", onMoveRight);
 ...
 * @param {Date} time
 */
oPublic.links.Timeline.prototype.setCurrentTime = function(time) {
    var now = new Date();
 ...
 * @return {Date} time
 */
oPublic.links.Timeline.prototype.getCurrentTime = function() {
    var now = new Date();
 ...
 * @param {Date} time
 */
oPublic.links.Timeline.prototype.setCustomTime = function(time) {
 ...
 */
oPublic.links.Timeline.prototype.getCustomTime = function() {
 ...
 *
 * @param {oPublic.links.Timeline.StepDate.SCALE} scale
 ...
 *                               example 1, 2, 5, or 10.
 */
oPublic.links.Timeline.prototype.setScale = function(scale, step) {
 ...
 */
oPublic.links.Timeline.prototype.setAutoScale = function(enable) {
 ...
 */
oPublic.links.Timeline.prototype.redraw = function() {
 ...
 */
oPublic.links.Timeline.prototype.checkResize = function() {
 ...
 * @param {oPublic.links.Timeline.Item} item
 * @return {boolean} editable
 */
oPublic.links.Timeline.prototype.isEditable = function (item) {
    if (item) {
 ...
 */
oPublic.links.Timeline.prototype.recalcConversion = function() {
 ...
 */
oPublic.links.Timeline.prototype.screenToTime = function(x) {
 ...
 *                      with the given date.
 */
oPublic.links.Timeline.prototype.timeToScreen = function(time) {
    var conversion = this.conversion;
 ...
 */
oPublic.links.Timeline.prototype.onTouchStart = function(event) {
    var params = this.eventParams,
        me = this;
    ...
    if (!params.onTouchMove) {
        ...
        oPublic.links.Timeline.addEventListener(document, "touchmove", params.onTouchMove);
    }
    if (!params.onTouchEnd) {
        params.onTouchEnd  = function (event) {me.onTouchEnd(event);};
        oPublic.links.Timeline.addEventListener(document, "touchend",  params.onTouchEnd);
    }
    ...
    /* TODO
     ...
     var target = oPublic.links.Timeline.getTarget(event);
 ...
 */
oPublic.links.Timeline.prototype.onTouchMove = function(event) {
    var params = this.eventParams;
 ...
 */
oPublic.links.Timeline.prototype.onTouchEnd = function(event) {
    var params = this.eventParams;
    var me = this;
    params.touchDown = false;
    ...
    if (params.onTouchMove) {
        oPublic.links.Timeline.removeEventListener(document, "touchmove", params.onTouchMove);
        delete params.onTouchMove;

    }
    if (params.onTouchEnd) {
        oPublic.links.Timeline.removeEventListener(document, "touchend",  params.onTouchEnd);
 ...
 */
oPublic.links.Timeline.prototype.onMouseDown = function(event) {
    ...
    // get mouse position
    params.mouseX = oPublic.links.Timeline.getPageX(event);
    params.mouseY = oPublic.links.Timeline.getPageY(event);
    params.frameLeft = oPublic.links.Timeline.getAbsoluteLeft(this.dom.content);
    params.frameTop = oPublic.links.Timeline.getAbsoluteTop(this.dom.content);
    ...
    params.target = oPublic.links.Timeline.getTarget(event);
    ...
    if (!params.touchDown) {
        ...
        if (!params.onMouseMove) {
            ...
            oPublic.links.Timeline.addEventListener(document, "mousemove", params.onMouseMove);
        }
        if (!params.onMouseUp) {
            params.onMouseUp = function (event) {me.onMouseUp(event);};
            oPublic.links.Timeline.addEventListener(document, "mouseup", params.onMouseUp);
        }
 ...
 * This function activated from within the funcion oPublic.links.Timeline.onMouseDown().
 * @param {Event}   event  Well, eehh, the event
 */
oPublic.links.Timeline.prototype.onMouseMove = function (event) {
    event = event || window.event;
    ...
    var mouseX = oPublic.links.Timeline.getPageX(event);
    var mouseY = oPublic.links.Timeline.getPageY(event);
 ...
 */
oPublic.links.Timeline.prototype.onMouseUp = function (event) {
    var params = this.eventParams,
        options = this.options;
    ...
    if (params.onMouseMove) {
        oPublic.links.Timeline.removeEventListener(document, "mousemove", params.onMouseMove);
        delete params.onMouseMove;
    }
    if (params.onMouseUp) {
        oPublic.links.Timeline.removeEventListener(document, "mouseup",   params.onMouseUp);
 ...
 * @param {Event}  event
 */
oPublic.links.Timeline.prototype.onDblClick = function (event) {
    var params = this.eventParams,
        options = this.options,
        dom = this.dom,
        size = this.size;
    ...
    if (params.itemIndex != undefined) {
        ...
        if (options.editable) {
            ...
            params.mouseX = oPublic.links.Timeline.getPageX(event);
            params.mouseY = oPublic.links.Timeline.getPageY(event);
            var x = params.mouseX - oPublic.links.Timeline.getAbsoluteLeft(dom.content);
            var y = params.mouseY - oPublic.links.Timeline.getAbsoluteTop(dom.content);
 ...
 * @param {Event}  event   The event
 */
oPublic.links.Timeline.prototype.onMouseWheel = function(event) {
    if (!this.options.zoomable)
        return;
    ...
    if (delta) {
        ...
        var zoom = function () {
            ...
            var frameLeft = oPublic.links.Timeline.getAbsoluteLeft(timeline.dom.content);
            var mouseX = oPublic.links.Timeline.getPageX(event);
            var zoomAroundDate =
 ...
 */
oPublic.links.Timeline.prototype.zoom = function(zoomFactor, zoomAroundDate) {
 ...
 */
oPublic.links.Timeline.prototype.move = function(moveFactor) {
    // zoom start Date and end Date relative to the zoomAroundDate
    var diff = (this.end.valueOf() - this.start.valueOf());
 ...
 */
oPublic.links.Timeline.prototype.applyRange = function (start, end, zoomAroundDate) {
 ...
 */
oPublic.links.Timeline.prototype.confirmDeleteItem = function(index) {
 ...
 */
oPublic.links.Timeline.prototype.deleteItem = function(index, preventRender) {
    ...
    if (this.data) {
        if (oPublic.google && oPublic.google.visualization &&
            this.data instanceof oPublic.google.visualization.DataTable) {
            this.data.removeRow(index);
        }
        else if (oPublic.links.Timeline.isArray(this.data)) {
 ...
 * Delete all items
 */
oPublic.links.Timeline.prototype.deleteAllItems = function() {
    this.unselectItem();
 ...
 *                                      of range
 */
oPublic.links.Timeline.prototype.getGroupFromHeight = function(height) {
    var i,
        group,
        groups = this.groups;
...
/**
 * @constructor oPublic.links.Timeline.Item
 ...
 *                                {Number} height
 */
oPublic.links.Timeline.Item = function (data, options) {
    if (data) {
        /* TODO: use parseJSONDate as soon as it is tested and working (in two directions)
         this.start = oPublic.links.Timeline.parseJSONDate(data.start);
         this.end = oPublic.links.Timeline.parseJSONDate(data.end);
         */
 ...
 * @return {boolean} resized    returns true if the axis is resized
 */
oPublic.links.Timeline.Item.prototype.reflow = function () {
 ...
 */
oPublic.links.Timeline.Item.prototype.getImageUrls = function (imageUrls) {
    if (this.dom) {
        oPublic.links.imageloader.filterImageUrls(this.dom, imageUrls);
    }
};
 ...
 * Select the item
 */
oPublic.links.Timeline.Item.prototype.select = function () {
    // Should be implemented by sub-prototype
};
 ...
 * Unselect the item
 */
oPublic.links.Timeline.Item.prototype.unselect = function () {
    // Should be implemented by sub-prototype
};
 ...
 */
oPublic.links.Timeline.Item.prototype.createDOM = function () {
    // Should be implemented by sub-prototype
};
 ...
 */
oPublic.links.Timeline.Item.prototype.showDOM = function (container) {
    // Should be implemented by sub-prototype
};
 ...
 * @param {Element} container
 */
oPublic.links.Timeline.Item.prototype.hideDOM = function (container) {
    // Should be implemented by sub-prototype
};
 ...
 * of the item
 */
oPublic.links.Timeline.Item.prototype.updateDOM = function () {
    // Should be implemented by sub-prototype
};
 ...
 * @param {oPublic.links.Timeline} timeline
 */
oPublic.links.Timeline.Item.prototype.updatePosition = function (timeline) {
    // Should be implemented by sub-prototype
};
 ...
 */
oPublic.links.Timeline.Item.prototype.isRendered = function () {
 ...
 */
oPublic.links.Timeline.Item.prototype.isVisible = function (start, end) {
    // Should be implemented by sub-prototype
    return false;
};
 ...
 * @param {Number} right
 */
oPublic.links.Timeline.Item.prototype.setPosition = function (left, right) {
    // Should be implemented by sub-prototype
};
 ...
 * @return {Number} right
 */
oPublic.links.Timeline.Item.prototype.getRight = function (timeline) {
    // Should be implemented by sub-prototype
    return 0;
};
 ...
 * @return {Number} width
 */
oPublic.links.Timeline.Item.prototype.getWidth = function (timeline) {
    // Should be implemented by sub-prototype
...
/**
 * @constructor oPublic.links.Timeline.ItemBox
 * @extends oPublic.links.Timeline.Item
 * @param {Object} data       Object containing parameters start, end
 ...
 *                                {Number} height
 */
oPublic.links.Timeline.ItemBox = function (data, options) {
    oPublic.links.Timeline.Item.call(this, data, options);
};

oPublic.links.Timeline.ItemBox.prototype = new oPublic.links.Timeline.Item();
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.reflow = function () {
    var dom = this.dom,
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.select = function () {
    var dom = this.dom;
    oPublic.links.Timeline.addClassName(dom, 'timeline-event-selected ui-state-active');
    oPublic.links.Timeline.addClassName(dom.line, 'timeline-event-selected ui-state-active');
    oPublic.links.Timeline.addClassName(dom.dot, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.unselect = function () {
    var dom = this.dom;
    oPublic.links.Timeline.removeClassName(dom, 'timeline-event-selected ui-state-active');
    oPublic.links.Timeline.removeClassName(dom.line, 'timeline-event-selected ui-state-active');
    oPublic.links.Timeline.removeClassName(dom.dot, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.createDOM = function () {
    // background box
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.showDOM = function (container) {
    var dom = this.dom;
    if (!dom) {
        dom = this.createDOM();
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.hideDOM = function () {
    var dom = this.dom;
    if (dom) {
        if (dom.parentNode) {
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.updateDOM = function () {
    var divBox = this.dom;
    if (divBox) {
        ...
        if (this.isCluster) {
            oPublic.links.Timeline.addClassName(divBox, 'timeline-event-cluster ui-widget-header');
            oPublic.links.Timeline.addClassName(divLine, 'timeline-event-cluster ui-widget-header');
            oPublic.links.Timeline.addClassName(divDot, 'timeline-event-cluster ui-widget-header');
        }

        // add item specific class name when provided
        if (this.className) {
            oPublic.links.Timeline.addClassName(divBox, this.className);
            oPublic.links.Timeline.addClassName(divLine, this.className);
            oPublic.links.Timeline.addClassName(divDot, this.className);
        }
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.updatePosition = function (timeline) {
    var dom = this.dom;
    if (dom) {
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.isVisible = function (start, end) {
    if (this.cluster) {
        return false;
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.setPosition = function (left, right) {
    var dom = this.dom;
 ...
 * @override
 */
oPublic.links.Timeline.ItemBox.prototype.getRight = function (timeline) {
...
/**
 * @constructor oPublic.links.Timeline.ItemRange
 * @extends oPublic.links.Timeline.Item
 * @param {Object} data       Object containing parameters start, end
 *                            content, group, type, className, editable.
 * @param {Object} [options]  Options to set initial property values
 ...
 *                                {Number} height
 */
oPublic.links.Timeline.ItemRange = function (data, options) {
    oPublic.links.Timeline.Item.call(this, data, options);
};

oPublic.links.Timeline.ItemRange.prototype = new oPublic.links.Timeline.Item();

/**
 * Select the item
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.select = function () {
    var dom = this.dom;
    oPublic.links.Timeline.addClassName(dom, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.unselect = function () {
    var dom = this.dom;
    oPublic.links.Timeline.removeClassName(dom, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.createDOM = function () {
    // background box
    var divBox = document.createElement("DIV");
    divBox.style.position = "absolute";
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.showDOM = function (container) {
    var dom = this.dom;
    if (!dom) {
        dom = this.createDOM();
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.hideDOM = function () {
    var dom = this.dom;
    if (dom) {
        if (dom.parentNode) {
            dom.parentNode.removeChild(dom);
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.updateDOM = function () {
    var divBox = this.dom;
    if (divBox) {
        // update contents
        divBox.firstChild.innerHTML = this.content;
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.updatePosition = function (timeline) {
    var dom = this.dom;
    if (dom) {
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.isVisible = function (start, end) {
    if (this.cluster) {
        return false;
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.setPosition = function (left, right) {
    var dom = this.dom;
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.getRight = function (timeline) {
 ...
 * @override
 */
oPublic.links.Timeline.ItemRange.prototype.getWidth = function (timeline) {
    return timeline.timeToScreen(this.end) - timeline.timeToScreen(this.start);
};

/**
 * @constructor oPublic.links.Timeline.ItemDot
 * @extends oPublic.links.Timeline.Item
 * @param {Object} data       Object containing parameters start, end
 *                            content, group, type, className, editable.
 * @param {Object} [options]  Options to set initial property values
 ...
 *                                {Number} height
 */
oPublic.links.Timeline.ItemDot = function (data, options) {
    oPublic.links.Timeline.Item.call(this, data, options);
};

oPublic.links.Timeline.ItemDot.prototype = new oPublic.links.Timeline.Item();
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.reflow = function () {
    var dom = this.dom,
        dotHeight = dom.dot.offsetHeight,
        dotWidth = dom.dot.offsetWidth,
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.select = function () {
    var dom = this.dom;
    oPublic.links.Timeline.addClassName(dom, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.unselect = function () {
    var dom = this.dom;
    oPublic.links.Timeline.removeClassName(dom, 'timeline-event-selected ui-state-active');
};
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.createDOM = function () {
    // background box
    var divBox = document.createElement("DIV");
    divBox.style.position = "absolute";
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.showDOM = function (container) {
    var dom = this.dom;
    if (!dom) {
        dom = this.createDOM();
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.hideDOM = function () {
    var dom = this.dom;
    if (dom) {
        if (dom.parentNode) {
            dom.parentNode.removeChild(dom);
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.updateDOM = function () {
    if (this.dom) {
        var divBox = this.dom;
        var divDot = divBox.dot;
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.updatePosition = function (timeline) {
    var dom = this.dom;
    if (dom) {
        var left = timeline.timeToScreen(this.start);
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.isVisible = function (start, end) {
    if (this.cluster) {
        return false;
    }
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.setPosition = function (left, right) {
    var dom = this.dom;
 ...
 * @override
 */
oPublic.links.Timeline.ItemDot.prototype.getRight = function (timeline) {
 ...
 */
oPublic.links.Timeline.prototype.getItem = function (index) {
    if (index >= this.items.length) {
 ...
 * @param {boolean} [preventRender=false]   Do not re-render timeline if true
 */
oPublic.links.Timeline.prototype.addItem = function (itemData, preventRender) {
    var itemsData = [
        itemData
    ];
 ...
 * @param {boolean} [preventRender=false]   Do not re-render timeline if true
 */
oPublic.links.Timeline.prototype.addItems = function (itemsData, preventRender) {
    var timeline = this,
        items = this.items;
 ...
 * @return {Object} item
 */
oPublic.links.Timeline.prototype.createItem = function(itemData) {
    ...
    return new oPublic.links.Timeline.Item(data, {
        'top': initialTop
    });
};
 ...
 * @param {boolean} [preventRender=false]   Do not re-render timeline if true
 */
oPublic.links.Timeline.prototype.changeItem = function (index, itemData, preventRender) {
 ...
 * Delete all groups
 */
oPublic.links.Timeline.prototype.deleteGroups = function () {
    this.groups = [];
    this.groupIndexes = {};
};
 ...
 */
oPublic.links.Timeline.prototype.getGroup = function (groupName) {
    var groups = this.groups,
 ...
 *                              was not provided
 */
oPublic.links.Timeline.prototype.getGroupName = function (groupObj) {
 ...
 */
oPublic.links.Timeline.prototype.cancelChange = function () {
 ...
 */
oPublic.links.Timeline.prototype.cancelDelete = function () {
 ...
 */
oPublic.links.Timeline.prototype.cancelAdd = function () {
    this.applyAdd = false;
};
 ...
 */
oPublic.links.Timeline.prototype.setSelection = function(selection) {
 ...
 */
oPublic.links.Timeline.prototype.getSelection = function() {
    var sel = [];
    if (this.selection) {
 ...
 * @param {Number} index
 */
oPublic.links.Timeline.prototype.selectItem = function(index) {
    this.unselectItem();
 ...
 */
oPublic.links.Timeline.prototype.isSelected = function (index) {
 ...
 */
oPublic.links.Timeline.prototype.unselectItem = function() {
    if (this.selection) {
 ...
 *                                         defaults to false.
 */
oPublic.links.Timeline.prototype.stackItems = function(animate) {
 ...
 */
oPublic.links.Timeline.prototype.stackCancelAnimation = function() {
 ...
 */
oPublic.links.Timeline.prototype.stackOrder = function(items) {
    ...
    {
        if ((a instanceof oPublic.links.Timeline.ItemRange) &&
            !(b instanceof oPublic.links.Timeline.ItemRange)) {
            return -1;
        }
 ...
 */
oPublic.links.Timeline.prototype.stackCalculateFinal = function(items) {
    var i,
        iMax,
        size = this.size,
 ...
 *                               location, else false
 */
oPublic.links.Timeline.prototype.stackMoveOneStep = function(currentItems, finalItems) {
    var arrived = true;
 ...
 *                               positions of the items
 */
oPublic.links.Timeline.prototype.stackMoveToFinal = function(currentItems, finalItems) {
 ...
 */
oPublic.links.Timeline.prototype.stackItemsCheckOverlap = function(items, itemIndex,
                                                           itemStart, itemEnd) {
 ...
 */
oPublic.links.Timeline.prototype.collision = function(item1, item2, margin) {
 ...
 */
oPublic.links.Timeline.prototype.trigger = function (event) {
    // built up properties
    var properties = null;
    switch (event) {
        case 'rangechange':
    ...
    // trigger the oPublic.links event bus
    oPublic.links.events.trigger(this, event, properties);

    // trigger the oPublic.google event bus
    if (oPublic.google && oPublic.google.visualization) {
        oPublic.google.visualization.events.trigger(this, event, properties);
    }
};
 ...
 * Cluster the events
 */
oPublic.links.Timeline.prototype.clusterItems = function () {
    if (!this.options.cluster) {
        return;
    }
 ...
 */
oPublic.links.Timeline.prototype.filterItems = function () {
    var queue = this.renderQueue,
...
/**
 * @constructor oPublic.links.Timeline.ClusterGenerator
 ...
 * @param {oPublic.links.Timeline} timeline
 */
oPublic.links.Timeline.ClusterGenerator = function (timeline) {
 ...
 */
oPublic.links.Timeline.ClusterGenerator.prototype.clear = function () {
 ...
 */
oPublic.links.Timeline.ClusterGenerator.prototype.clearCache = function () {
    // cache containing created clusters for each cluster level
    this.cache = {};
    this.cacheLevel = -1;
 ...
 */
oPublic.links.Timeline.ClusterGenerator.prototype.setData = function (items, options) {
    this.items = items || [];
 ...
 * the current level
 */
oPublic.links.Timeline.ClusterGenerator.prototype.updateData = function () {
    this.dataChanged = true;
 ...
 * @private
 */
oPublic.links.Timeline.ClusterGenerator.prototype.filterData = function () {
    // filter per group
    var items = this.items || [];
    var groups = {};
    this.groups = groups;
 ...
 */
oPublic.links.Timeline.ClusterGenerator.prototype.getClusters = function (scale) {
    var level = -1,
                ...
                while (i < iMax) {
                    ...
                    if (neighbors > maxItems) {
                        ...
                        while (clusterItems.length < num && m < items.length) {
                            ...
                            containsRanges = containsRanges || (p instanceof oPublic.links.Timeline.ItemRange);
                            count++;
                            m++;
                        }
 ...
 */
oPublic.links.events = oPublic.links.events || {
    'listeners': [],
...
/**
 * @constructor  oPublic.links.Timeline.StepDate
 ...
 */
oPublic.links.Timeline.StepDate = function(start, end, minimumStep) {
    ...
    this.autoScale  = true;
    this.scale = oPublic.links.Timeline.StepDate.SCALE.DAY;
    this.step = 1;
...
/// enum scale
oPublic.links.Timeline.StepDate.SCALE = {
    MILLISECOND: 1,
    SECOND: 2,
    MINUTE: 3,
    HOUR: 4,
 ...
 */
oPublic.links.Timeline.StepDate.prototype.setRange = function(start, end, minimumStep) {
 ...
 */
oPublic.links.Timeline.StepDate.prototype.start = function() {
 ...
 */
oPublic.links.Timeline.StepDate.prototype.roundToMinor = function() {
    // round to floor
    // IMPORTANT: we have no breaks in this switch! (this is no bug)
    //noinspection FallthroughInSwitchStatementJS
    switch (this.scale) {
        case oPublic.links.Timeline.StepDate.SCALE.YEAR:
            this.current.setFullYear(this.step * Math.floor(this.current.getFullYear() / this.step));
            this.current.setMonth(0);
        case oPublic.links.Timeline.StepDate.SCALE.MONTH:        this.current.setDate(1);
        case oPublic.links.Timeline.StepDate.SCALE.DAY:          // intentional fall through
        case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      this.current.setHours(0);
        case oPublic.links.Timeline.StepDate.SCALE.HOUR:         this.current.setMinutes(0);
        case oPublic.links.Timeline.StepDate.SCALE.MINUTE:       this.current.setSeconds(0);
        case oPublic.links.Timeline.StepDate.SCALE.SECOND:       this.current.setMilliseconds(0);
        //case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND: // nothing to do for milliseconds
    }

    if (this.step != 1) {
        // round down to the first minor value that is a multiple of the current step size
        switch (this.scale) {
            case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:  this.current.setMilliseconds(this.current.getMilliseconds() - this.current.getMilliseconds() % this.step);  break;
            case oPublic.links.Timeline.StepDate.SCALE.SECOND:       this.current.setSeconds(this.current.getSeconds() - this.current.getSeconds() % this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.MINUTE:       this.current.setMinutes(this.current.getMinutes() - this.current.getMinutes() % this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.HOUR:         this.current.setHours(this.current.getHours() - this.current.getHours() % this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      // intentional fall through
            case oPublic.links.Timeline.StepDate.SCALE.DAY:          this.current.setDate((this.current.getDate()-1) - (this.current.getDate()-1) % this.step + 1); break;
            case oPublic.links.Timeline.StepDate.SCALE.MONTH:        this.current.setMonth(this.current.getMonth() - this.current.getMonth() % this.step);  break;
            case oPublic.links.Timeline.StepDate.SCALE.YEAR:         this.current.setFullYear(this.current.getFullYear() - this.current.getFullYear() % this.step); break;
            default: break;
        }
    }
};
 ...
 */
oPublic.links.Timeline.StepDate.prototype.end = function () {
 ...
 * Do the next step
 */
oPublic.links.Timeline.StepDate.prototype.next = function() {
    ...
    if (this.current.getMonth() < 6)   {
        switch (this.scale) {
            case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:

                this.current = new Date(this.current.valueOf() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.SECOND:       this.current = new Date(this.current.valueOf() + this.step * 1000); break;
            case oPublic.links.Timeline.StepDate.SCALE.MINUTE:       this.current = new Date(this.current.valueOf() + this.step * 1000 * 60); break;
            case oPublic.links.Timeline.StepDate.SCALE.HOUR:
                ...
                break;
            case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      // intentional fall through
            case oPublic.links.Timeline.StepDate.SCALE.DAY:          this.current.setDate(this.current.getDate() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.MONTH:        this.current.setMonth(this.current.getMonth() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.YEAR:         this.current.setFullYear(this.current.getFullYear() + this.step); break;
            default:                      break;
        }
    }
    else {
        switch (this.scale) {
            case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:  this.current = new Date(this.current.valueOf() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.SECOND:       this.current.setSeconds(this.current.getSeconds() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.MINUTE:       this.current.setMinutes(this.current.getMinutes() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.HOUR:         this.current.setHours(this.current.getHours() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      // intentional fall through
            case oPublic.links.Timeline.StepDate.SCALE.DAY:          this.current.setDate(this.current.getDate() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.MONTH:        this.current.setMonth(this.current.getMonth() + this.step); break;
            case oPublic.links.Timeline.StepDate.SCALE.YEAR:         this.current.setFullYear(this.current.getFullYear() + this.step); break;
    ...
    if (this.step != 1) {
        ...
        switch (this.scale) {
            case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:  if(this.current.getMilliseconds() < this.step) this.current.setMilliseconds(0);  break;
            case oPublic.links.Timeline.StepDate.SCALE.SECOND:       if(this.current.getSeconds() < this.step) this.current.setSeconds(0);  break;
            case oPublic.links.Timeline.StepDate.SCALE.MINUTE:       if(this.current.getMinutes() < this.step) this.current.setMinutes(0);  break;
            case oPublic.links.Timeline.StepDate.SCALE.HOUR:         if(this.current.getHours() < this.step) this.current.setHours(0);  break;
            case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      // intentional fall through
            case oPublic.links.Timeline.StepDate.SCALE.DAY:          if(this.current.getDate() < this.step+1) this.current.setDate(1); break;
            case oPublic.links.Timeline.StepDate.SCALE.MONTH:        if(this.current.getMonth() < this.step) this.current.setMonth(0);  break;
            case oPublic.links.Timeline.StepDate.SCALE.YEAR:         break; // nothing to do for year
            default:                break;
        }
    }
 ...
 */
oPublic.links.Timeline.StepDate.prototype.getCurrent = function() {
    return this.current;
};
 ...
 * in minor steps of 5 minutes, and major steps of an hour.
 *
 * @param {oPublic.links.Timeline.StepDate.SCALE} newScale
 *                               A scale. Choose from SCALE.MILLISECOND,
 *                               SCALE.SECOND, SCALE.MINUTE, SCALE.HOUR,
 *                               SCALE.WEEKDAY, SCALE.DAY, SCALE.MONTH,
 *                               SCALE.YEAR.
 ...
 *                               example 1, 2, 5, or 10.
 */
oPublic.links.Timeline.StepDate.prototype.setScale = function(newScale, newStep) {
    this.scale = newScale;
 ...
 */
oPublic.links.Timeline.StepDate.prototype.setAutoScale = function (enable) {
 ...
 */
oPublic.links.Timeline.StepDate.prototype.setMinimumStep = function(minimumStep) {
    ...
    if (stepYear*1000 > minimumStep)        {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 1000;}
    if (stepYear*500 > minimumStep)         {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 500;}
    if (stepYear*100 > minimumStep)         {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 100;}
    if (stepYear*50 > minimumStep)          {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 50;}
    if (stepYear*10 > minimumStep)          {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 10;}
    if (stepYear*5 > minimumStep)           {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 5;}
    if (stepYear > minimumStep)             {this.scale = oPublic.links.Timeline.StepDate.SCALE.YEAR;        this.step = 1;}
    if (stepMonth*3 > minimumStep)          {this.scale = oPublic.links.Timeline.StepDate.SCALE.MONTH;       this.step = 3;}
    if (stepMonth > minimumStep)            {this.scale = oPublic.links.Timeline.StepDate.SCALE.MONTH;       this.step = 1;}
    if (stepDay*5 > minimumStep)            {this.scale = oPublic.links.Timeline.StepDate.SCALE.DAY;         this.step = 5;}
    if (stepDay*2 > minimumStep)            {this.scale = oPublic.links.Timeline.StepDate.SCALE.DAY;         this.step = 2;}
    if (stepDay > minimumStep)              {this.scale = oPublic.links.Timeline.StepDate.SCALE.DAY;         this.step = 1;}
    if (stepDay/2 > minimumStep)            {this.scale = oPublic.links.Timeline.StepDate.SCALE.WEEKDAY;     this.step = 1;}
    if (stepHour*4 > minimumStep)           {this.scale = oPublic.links.Timeline.StepDate.SCALE.HOUR;        this.step = 4;}
    if (stepHour > minimumStep)             {this.scale = oPublic.links.Timeline.StepDate.SCALE.HOUR;        this.step = 1;}
    if (stepMinute*15 > minimumStep)        {this.scale = oPublic.links.Timeline.StepDate.SCALE.MINUTE;      this.step = 15;}
    if (stepMinute*10 > minimumStep)        {this.scale = oPublic.links.Timeline.StepDate.SCALE.MINUTE;      this.step = 10;}
    if (stepMinute*5 > minimumStep)         {this.scale = oPublic.links.Timeline.StepDate.SCALE.MINUTE;      this.step = 5;}
    if (stepMinute > minimumStep)           {this.scale = oPublic.links.Timeline.StepDate.SCALE.MINUTE;      this.step = 1;}
    if (stepSecond*15 > minimumStep)        {this.scale = oPublic.links.Timeline.StepDate.SCALE.SECOND;      this.step = 15;}
    if (stepSecond*10 > minimumStep)        {this.scale = oPublic.links.Timeline.StepDate.SCALE.SECOND;      this.step = 10;}
    if (stepSecond*5 > minimumStep)         {this.scale = oPublic.links.Timeline.StepDate.SCALE.SECOND;      this.step = 5;}
    if (stepSecond > minimumStep)           {this.scale = oPublic.links.Timeline.StepDate.SCALE.SECOND;      this.step = 1;}
    if (stepMillisecond*200 > minimumStep)  {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 200;}
    if (stepMillisecond*100 > minimumStep)  {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 100;}
    if (stepMillisecond*50 > minimumStep)   {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 50;}
    if (stepMillisecond*10 > minimumStep)   {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 10;}
    if (stepMillisecond*5 > minimumStep)    {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 5;}
    if (stepMillisecond > minimumStep)      {this.scale = oPublic.links.Timeline.StepDate.SCALE.MILLISECOND; this.step = 1;}
};
 ...
 */
oPublic.links.Timeline.StepDate.prototype.snap = function(date) {
    if (this.scale == oPublic.links.Timeline.StepDate.SCALE.YEAR) {
    ...
    else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.MONTH) {
        if (date.getDate() > 15) {
            date.setDate(1);
    ...
    else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.DAY ||
        this.scale == oPublic.links.Timeline.StepDate.SCALE.WEEKDAY) {
        switch (this.step) {
            case 5:
            case 2:
    ...
    else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.HOUR) {
        switch (this.step) {
            case 4:
        ...
        date.setSeconds(0);
        date.setMilliseconds(0);
    } else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.MINUTE) {
        switch (this.step) {
            case 15:
            case 10:
    ...
    else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.SECOND) {
        switch (this.step) {
            case 15:
            case 10:
    ...
    else if (this.scale == oPublic.links.Timeline.StepDate.SCALE.MILLISECOND) {
 ...
 */
oPublic.links.Timeline.StepDate.prototype.isMajor = function() {
    switch (this.scale) {
        case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:
            return (this.current.getMilliseconds() == 0);
        case oPublic.links.Timeline.StepDate.SCALE.SECOND:
            return (this.current.getSeconds() == 0);
        case oPublic.links.Timeline.StepDate.SCALE.MINUTE:
            return (this.current.getHours() == 0) && (this.current.getMinutes() == 0);
        // Note: this is no bug. Major label is equal for both minute and hour scale
        case oPublic.links.Timeline.StepDate.SCALE.HOUR:
            return (this.current.getHours() == 0);
        case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY: // intentional fall through
        case oPublic.links.Timeline.StepDate.SCALE.DAY:
            return (this.current.getDate() == 1);
        case oPublic.links.Timeline.StepDate.SCALE.MONTH:
 ...
 */
oPublic.links.Timeline.StepDate.prototype.getLabelMinor = function(options, date) {
    if (date == undefined) {
        date = this.current;
    }

    switch (this.scale) {
        case oPublic.links.Timeline.StepDate.SCALE.MILLISECOND:  return String(date.getMilliseconds());
        case oPublic.links.Timeline.StepDate.SCALE.SECOND:       return String(date.getSeconds());
        case oPublic.links.Timeline.StepDate.SCALE.MINUTE:
            return this.addZeros(date.getHours(), 2) + ":" + this.addZeros(date.getMinutes(), 2);
        case oPublic.links.Timeline.StepDate.SCALE.HOUR:
            return this.addZeros(date.getHours(), 2) + ":" + this.addZeros(date.getMinutes(), 2);
        case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:      return options.DAYS_SHORT[date.getDay()] + ' ' + date.getDate();
        case oPublic.links.Timeline.StepDate.SCALE.DAY:          return String(date.getDate());
        case oPublic.links.Timeline.StepDate.SCALE.MONTH:        return options.MONTHS_SHORT[date.getMonth()];   // month is zero based
        case oPublic.links.Timeline.StepDate.SCALE.YEAR:         return String(date.getFullYear());
        default:                                         return "";
    }
};
 ...
 * @param {Date} [date] custom date. if not provided, current date is taken
 */
oPublic.links.Timeline.StepDate.prototype.getLabelMajor = function(options, date) {
    if (date == undefined) {
        date = this.current;
    }
    ...
    switch (this.scale) {
        ...
        case oPublic.links.Timeline.StepDate.SCALE.HOUR:
            return  options.DAYS[date.getDay()] + " " +
                ...
                options.MONTHS[date.getMonth()] + " " +
                date.getFullYear();
        case oPublic.links.Timeline.StepDate.SCALE.WEEKDAY:
        case oPublic.links.Timeline.StepDate.SCALE.DAY:
 ...
 */
oPublic.links.Timeline.StepDate.prototype.addZeros = function(value, len) {
    var str = "" + value;
 ...
 *
 */
oPublic.links.imageloader = (function () {
 ...
 */
oPublic.links.Timeline.addEventListener = function (element, action, listener, useCapture) {
 ...
 * @param {boolean}      useCapture
 */
oPublic.links.Timeline.removeEventListener = function(element, action, listener, useCapture) {
 ...
 */
oPublic.links.Timeline.getTarget = function (event) {
 ...
 */
oPublic.links.Timeline.stopPropagation = function (event) {
    if (!event)
        event = window.event;
 ...
 */
oPublic.links.Timeline.preventDefault = function (event) {
    if (!event)
        event = window.event;
 ...
 *                              in the browser page.
 */
oPublic.links.Timeline.getAbsoluteLeft = function(elem) {
 ...
 *                              in the browser page.
 */
oPublic.links.Timeline.getAbsoluteTop = function(elem) {
    var doc = document.documentElement;
    var body = document.body;
 ...
 * @return {Number} pageY
 */
oPublic.links.Timeline.getPageY = function (event) {
 ...
 * @return {Number} pageX
 */
oPublic.links.Timeline.getPageX = function (event) {
    if (('targetTouches' in event) && event.targetTouches.length) {
        event = event.targetTouches[0];
    }
 ...
 */
oPublic.links.Timeline.addClassName = function(elem, className) {
 ...
 * @param {String} className
 */
oPublic.links.Timeline.removeClassName = function(elem, className) {
    var classes = elem.className.split(' ');
...
oPublic.links.Timeline.isArray = function (obj) {
 ...
 */
oPublic.links.Timeline.parseJSONDate = function (date) {
    if (date == undefined) {
        return undefined;
    }
